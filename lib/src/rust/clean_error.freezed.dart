...
bool operator ==(Object other) {
  final _this = this as CleanError;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CleanError&&(identical(other.message, _this.message) || other.message == _this.message));
}
...
String toString() {
  final _this = this as CleanError;
  return 'CleanError(message: ${_this.message})';
}
